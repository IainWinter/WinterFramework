...
// also this breaks with event_defer because the handle becomes invliad on a call to add or remove
// should make the handle an index into a vector or something for a global handle
// maybe make a layer ontop as a quick hack .. ?
